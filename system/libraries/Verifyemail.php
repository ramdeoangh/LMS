 ...
 */ 
 class CI_Verifyemail { 
     ...
     public function setEmailFrom($email) { 
         if (!self::validate($email)) { 
             ...
             if ($this->exceptions) { 
                 throw new CI_VerifyemailException($this->ErrorInfo); 
             } 
         } 
         $this->from = $email; 
     } 
      ...
      * @see CI_Verifyemail::$Debugoutput 
      * @see CI_Verifyemail::$Debug 
      * @param string $str 
      */ 
 ...
 /** 
  * CI_Verifyemail exception handler 
  */ 
 class CI_VerifyemailException extends Exception { 

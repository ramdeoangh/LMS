...
<section class="sign-up my-5 pt-5">
    ...
    <div class="lmspinner">
        <div class="text-center">
            <div class="spinner-border justify-content-center text-success"
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12 col-12 ">
                <div class="sing-up-right">
                    <h3>
                        <?php echo get_phrase('Email Verification'); ?><span>!</span>
                    </h3>
                    <p>
                        <?php echo get_phrase('Enter your verification code here') ?>
                    </p>

                    <form action="<?php echo site_url('login/verify_email_address') ?>" method="post">
                        <div class="mb-3">
                            <h5>
                                <?php echo get_phrase('Verification code'); ?>
                            </h5>
                            <div class="position-relative">
                                <i class="fa-solid fa-user"></i>
                                <input class="form-control" id="verification_code" type="text" name="verification_code"
                                    placeholder="<?php echo get_phrase('Enter your verification code'); ?>">
                            </div>
                            <a href="javascript:;" class="text-14px fw-500 text-muted" id="resend_mail_button"
                                onclick="resend_verification_code()">
                                <div class="float-start">
                                    <?= site_phrase('resend_mail') ?>
                                </div>
